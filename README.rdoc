...
It relays on connection to Facebook set up via the Facebook JavaScript SDK.

== Warning

I guess a small warning is in it's place. Right now, this gem is kinda a prototype for me. Don't expect anything to
work ;-) ..Even though committed code do work for me in my Rails 3 beta 3 application :-)
...
at the bottom of the page, before </body>. Add it with the helper facebook_init_javascript_sdk. I guess
